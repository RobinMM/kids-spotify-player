...
const translations = {
    en: {
        ...
        'settings.restartLibrespot': 'Restart Player',
        'settings.librespotRestarted': 'Player restarted',
        'settings.librespotRestartFailed': 'Failed to restart player',
        ...
        'bt.pair': 'Pair',
        'bt.rename': 'Rename',
        'bt.renamePrompt': 'Enter new name:',
        'bt.autoConnect': 'Automatically connect when powered on',
        ...
        'bt.renamed': 'Device renamed',
        'bt.renameFailed': 'Rename failed',
        'bt.renameError': 'Error renaming',
    ...
    nl: {
        ...
        'settings.restartLibrespot': 'Herstart Speler',
        'settings.librespotRestarted': 'Speler herstart',
        'settings.librespotRestartFailed': 'Herstart speler mislukt',
        ...
        'bt.pair': 'Koppelen',
        'bt.rename': 'Hernoemen',
        'bt.renamePrompt': 'Voer nieuwe naam in:',
        'bt.autoConnect': 'Automatisch verbinden bij inschakelen',
        ...
        'bt.renamed': 'Apparaat hernoemd',
        'bt.renameFailed': 'Hernoemen mislukt',
        'bt.renameError': 'Fout bij hernoemen',
